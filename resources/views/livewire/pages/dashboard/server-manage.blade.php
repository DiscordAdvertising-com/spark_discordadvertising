<div>
    <h1 class="text-3xl text-white font-semibold">Manage Server</h1>
    ...
    <div class="mt-10">
        <div class="w-full p-6 bg-dsb rounded-lg border border-db relative overflow-hidden ">
            ...
            <div class="max-w-[50rem] grid gap-y-6 mt-6">
                ...
                <h1 class="text-sm text-gray-500">By updating your server listing you accept Discord Advertising's TOS<i class="fa-solid fa-arrow-right ml-1 text-accent"></i></h1>
            </div>
        </div>
    </div>
</div>
