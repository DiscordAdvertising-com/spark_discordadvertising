<div>
    ...
    <h1 class="text-3xl text-white font-semibold">Upload Server</h1>
    <div class="mt-10">
        <div class="w-full p-6 bg-dsb rounded-lg border border-db relative overflow-hidden ">
            <h1 class="text-gray-200 text-xl font-bold border-b border-opacity-10 border-white pb-6"> <span class="text-accent">Step 1.</span> - Server Credentials</h1>
            <div class="max-w-[50rem] grid gap-y-6 mt-6">

                <div class="grid gap-y-2">

                    <label class="text-gray-400" for="serverid">Server ID</label>
                    <div class="md:flex grid gap-5">
                        ...
                        <button wire:click="findServer" class="w-[11rem] md:h-auto h-[56px] bg-accent hover:bg-accent/60 rounded-lg text-white font-semibold"> <li class="fa-solid fa-search"></li> Find Server</button>
                        <button class="w-[11rem] md:h-auto h-[56px] bg-accent hover:bg-accent/60 rounded-lg text-white font-semibold"><a href="https://discord.com/api/oauth2/authorize?client_id=1141540520791920711&permissions=2147485696&scope=applications.commands%20bot" class=" h-[56px]"> <li class="fa-solid fa-plus"></li> Add Bot </a></button>
                    </div>
    ...
    @if($server)
        <div class="mt-10 relative">
            <div class="w-full bg-dsb rounded-lg border border-db relative overflow-hidden ">
                <div class="p-6">
                    <h1 class="text-gray-200 text-xl font-bold border-b border-opacity-10 border-white pb-6"> <span class="text-accent">Step 2.</span> - Server Descriptions</h1>
                    <div class="max-w-[50rem] grid gap-y-6 mt-6">
                        ...
                        <div class="grid gap-y-2">
                            ...
                            <label class="text-gray-400" for="description">Server Description</label>
                            <div class="flex gap-x-5 relative">
                        ...
                        <div class="grid gap-y-5">
                            ...
                            <label class="text-gray-400" for="clientid">Server Tags</label>
    ...
    @if(count($addedTags) != 0 && strlen($description) != 0 && strlen($headline))
        <div class="mt-10">
            <div class="w-full p-6 bg-dsb rounded-lg border border-db relative overflow-hidden ">
                <h1 class="text-gray-200 text-xl font-bold border-b border-opacity-10 border-white pb-6"> <span class="text-accent">Step 3.</span> - Server Owners</h1>
                <div class="max-w-[50rem] grid gap-y-6 mt-6">

                    <div class="grid gap-y-2">

                        <label class="text-gray-400" for="accoutid">Discord ID</label>
                        <div class="md:flex grid gap-5">
                            <input name="accoutid" wire:model="accountID" type="text"
                            class="w-full bg-input p-4 rounded-lg focus:ring-2 focus:ring-accent  focus:outline-none text-gray-200" required>
    ...
    @if(count($addedTags) != 0 && strlen($description) != 0 && strlen($headline))
        <div class="mt-10">
            <div class="w-full p-6 bg-dsb rounded-lg border border-db relative overflow-hidden ">
                <h1 class="text-gray-200 text-xl font-bold border-b border-opacity-10 border-white pb-6"> <span class="text-accent">Step 4.</span> - Finish Server Listing</h1>
                <div class="max-w-[50rem] grid gap-y-6 mt-6">
                    <div class="grid gap-y-2">
        
                        <label class="text-gray-400" for="invite">Server Invite Link</label>
                        <div class="md:flex grid gap-5">
                    ...
                    <div class="grid gap-y-2">
                        ...
                        @endif
                        <li class="fa-solid fa-arrow-right ml-1 text-accent">
                        <a href="{{route('tos')}}" class="text-sm text-gray-500">By creating a server listing you agree to our ToS</a>
                    </li>
