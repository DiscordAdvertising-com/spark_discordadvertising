<div>
    ...
    <div class="mt-10">
        ...
        <div class="w-full flex gap-x-10">
            ...
            <div class="w-2/3 tracking-widest text-gray-400 grid gap-y-5">

                <h1 class="text-3xl text-white font-semibold border-b pb-4 border-gray-500 border-opacity-40">{{$bot['username']}}</h1>
