<div x-data="{search: false, tags: false}">
    ...
    <div class="relative z-20" @click.away="search = false">
        <div class="w-[45rem] flex gap-x-5 mt-10">
            ...
            <button class=" h-[68px] w-[68px] bg-accent rounded-lg text-white font-semibold p-5 text-lg" wire:click="search" @click="search = false"> <li class="fa-solid fa-search text-xl"></li></button>
        </div>
                        ...
                        <a class="flex gap-x-5 hover:bg-db p-2 rounded-lg hover:cursor-pointer" @click="search = false" href="{{route('botInfo', ['botID' => $bot['id']])}}">
                            ...
                            <div>
                                ...
                                <div class="flex gap-x-5 w-fit my-3 text-gray-300 font-semibold bg-dmb rounded-lg px-2">
                                    <h1 class="flex gap-x-1 "><span class="text-accent"><li class="fa-solid fa-arrow-up text-sm"></li> {{count($bot->votes)}}</span></h1>
