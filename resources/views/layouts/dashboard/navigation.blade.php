    ...
    <div class="  h-[calc(100vh-80px)] p-6 mt-[80px] space-y-8">
        ...
        <div>
            ...
            <ul class="text-gray-200 mt-4 grid gap-y-1">
                ...
                <li class="hover:bg-dmb cursor-pointer flex gap-4 text-lg py-2 px-3 rounded-lg @if($page == 'dashboard') bg-dmb @endif"><i class="fa-solid fa-upload text-accent my-auto w-[20px]"></i><h1 class="text-base">Upload</h1></li>
