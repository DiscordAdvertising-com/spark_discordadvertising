    ...
    <div class="  h-[calc(100vh-80px)] p-6 mt-[80px] space-y-8">
        ...
        <div>
            ...
            <ul class="text-gray-200 mt-4 grid gap-y-1">
                ...
                <a href="{{url()}}/dashboard/premium" class="hover:bg-dmb  @if($page == 'premium') bg-dmb @endif cursor-pointer flex gap-4 text-lg py-2 px-3 rounded-lg"><i class="fa-solid fa-star text-accent my-auto w-[20px]"></i><h1 class="text-base">Premium</h1></a>
                {{-- <a href="{{route('logout')}}"> --}}
